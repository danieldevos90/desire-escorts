...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    title: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Contact'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPricingPricing extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    rates: Schema.Attribute.Component<'rate-item.rate-item', true>;
    site: Schema.Attribute.Relation<'manyToOne', 'api::site.site'>;
    title: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Pricing'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProfileProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    attributesList: Schema.Attribute.Component<'attribute.attribute', true>;
    availability: Schema.Attribute.Component<'availability.availability', true>;
    ...
    siteOverrides: Schema.Attribute.Component<
...
export interface ApiSiteSettingsSiteSettings
  ...
  attributes: {
    ...
    legalPagesRefs: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiSiteSite extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    profiles: Schema.Attribute.Relation<'manyToMany', 'api::profile.profile'>;
    publishedAt: Schema.Attribute.DateTime;
    seoDefaults: Schema.Attribute.Component<'seo.seo', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
